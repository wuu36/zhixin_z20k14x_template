...
/**
 * @file     Z20K148M.h
 * @brief    Z20K148M device header file.
 * @version  V1.0.0
 * @date     December-2022
 ...
 */
#define CAN_INSTANCE_NUM      (8U)
#define I2S_INSTANCE_NUM      (2U)
...
#define FLASH_CODE_END_ADDR            ((uint32_t)0x001FFFFF)            /*!< program/Code flash end address */
...
#define SRAML_BASE_ADDR                ((uint32_t)0x1FFE0000)            /*!< SRAML base address */
#define SRAML_END_ADDR                 ((uint32_t)0x1FFFFFFF)            /*!< SRAML end address */
...
#define I2S1_BASE_ADDR             (PERIPHERAL_BASE_ADDR + 0x55000UL)       /*!< I2S1 base address */
#define CAN6_BASE_ADDR             (PERIPHERAL_BASE_ADDR + 0x56000UL)       /*!< CAN6 base address */
#define CAN7_BASE_ADDR             (PERIPHERAL_BASE_ADDR + 0x57000UL)       /*!< CAN7 base address */
...
typedef enum IRQn
{
    ...
    CAN6_BusOff_IRQn = 127,        /*!< CAN 6 bus off/ bus off done Interrupt */
    CAN6_TxWarn_IRQn = 128,        /*!< CAN 6 TX warning Interrupt */
    CAN6_RxWarn_IRQn = 129,        /*!< CAN 6 RX warning Interrupt */
    CAN6_Err_IRQn = 130,           /*!< CAN 6 error Interrupt */
    CAN6_ErrFd_IRQn = 131,         /*!< CAN 6 error FD Interrupt */
    CAN6_PnWake_IRQn = 132,        /*!< CAN 6 PN wakeup Interrupt */
    CAN6_SelfWakeup_IRQn = 133,    /*!< CAN 6 self wakeup Interrupt */
    CAN6_Ecc_IRQn = 134,           /*!< CAN 6 ECC Interrupt */
    CAN6_Mb0To31_IRQn = 135,       /*!< CAN 6 message buffer 0-31 Interrupt */
    CAN6_Mb32To63_IRQn = 136,      /*!< CAN 6 message buffer 32-63 Interrupt */
    CAN6_Mb64To95_IRQn = 137,      /*!< CAN 6 message buffer 64-95 Interrupt */
    CAN6_Mb96To127_IRQn = 138,     /*!< CAN 6 message buffer 96-127 Interrupt */
    CAN7_BusOff_IRQn = 139,        /*!< CAN 7 bus off/ bus off done Interrupt */
    CAN7_TxWarn_IRQn = 140,        /*!< CAN 7 TX warning Interrupt */
    CAN7_RxWarn_IRQn = 141,        /*!< CAN 7 RX warning Interrupt */
    CAN7_Err_IRQn = 142,           /*!< CAN 7 error Interrupt */
    CAN7_ErrFd_IRQn = 143,         /*!< CAN 7 error FD Interrupt */
    CAN7_PnWake_IRQn = 144,        /*!< CAN 7 PN wakeup Interrupt */
    CAN7_SelfWakeup_IRQn = 145,    /*!< CAN 7 self wakeup Interrupt */
    CAN7_Ecc_IRQn = 146,           /*!< CAN 7 ECC Interrupt */
    CAN7_Mb0To31_IRQn = 147,       /*!< CAN 7 message buffer 0-31 Interrupt */
    CAN7_Mb32To63_IRQn = 148,      /*!< CAN 7 message buffer 32-63 Interrupt */
    CAN7_Mb64To95_IRQn = 149,      /*!< CAN 7 message buffer 64-95 Interrupt */
    CAN7_Mb96To127_IRQn = 150,     /*!< CAN 7 message buffer 96-127 Interrupt */
